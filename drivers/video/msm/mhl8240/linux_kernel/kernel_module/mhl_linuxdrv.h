...
#define MHL_PART_NAME "SiI-8240"	// WARNING! Must match I2C_BOARD_INFO() setting in board-omap3beagle.c
...
//ASUS_BSP larry lai :for ATD test +++	
	uint8_t				mhl_status;			// by user mode ATD application
//ASUS_BSP larry lai :for ATD test ---	
      struct input_dev *input_dev_key;
//ASUS_BSP +++ : lockup TV mode to prevent enter suspend mode
	struct wake_lock mhl_wlock;
//ASUS_BSP --- : lockup TV mode to prevent enter suspend mode
