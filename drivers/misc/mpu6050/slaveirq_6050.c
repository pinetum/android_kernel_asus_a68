...
int slaveirq_init_6050(struct i2c_adapter *slave_adapter,
...
//ASUS_BSP +++ Jiunhau_Wang "[A80][Sensor][NA][Spec] change Gyro INT pin : rising -> falling"
...
void slaveirq_exit_6050(struct ext_slave_platform_data *pdata)
{
