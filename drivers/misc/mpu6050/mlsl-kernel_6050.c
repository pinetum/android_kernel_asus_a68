...
int inv_serial_single_write_6050(
	void *sl_handle,
...
EXPORT_SYMBOL(inv_serial_single_write_6050);

int inv_serial_write_6050(
	void *sl_handle,
	unsigned char slave_addr,
...
EXPORT_SYMBOL(inv_serial_write_6050);

int inv_serial_read_6050(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned char register_addr,
	unsigned short length,
...
EXPORT_SYMBOL(inv_serial_read_6050);

int inv_serial_write_mem_6050(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned short mem_addr,
	unsigned short length,
...
EXPORT_SYMBOL(inv_serial_write_mem_6050);

int inv_serial_read_mem_6050(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned short mem_addr,
	unsigned short length,
...
EXPORT_SYMBOL(inv_serial_read_mem_6050);

int inv_serial_write_fifo_6050(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned short length,
	unsigned char const *data)
...
EXPORT_SYMBOL(inv_serial_write_fifo_6050);

int inv_serial_read_fifo_6050(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned short length,
	unsigned char *data)
...
EXPORT_SYMBOL(inv_serial_read_fifo_6050);
