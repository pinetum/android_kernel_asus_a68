...
static char *keymaster_0 = NULL;
static char *keymaster_1 = NULL;
static char *keymaster_2 = NULL;
static char *keymaster_3 = NULL;
static char *keymaster_m = NULL;
module_param(keymaster_0, charp, S_IRUGO | S_IWUSR);
module_param(keymaster_1, charp, S_IRUGO | S_IWUSR);
module_param(keymaster_2, charp, S_IRUGO | S_IWUSR);
module_param(keymaster_3, charp, S_IRUGO | S_IWUSR);
module_param(keymaster_m, charp, S_IRUGO | S_IWUSR);
//ASUS_BSP Cliff---
...
//ASUS_BSP Cliff+++
    ...
    if( (g_A68_cpuID >= 714) && (g_A68_cpuID <= 719) ) {
        ...
        sprintf((char *)(tzapps_0), "tzapps_715.b00");
        sprintf((char *)(tzapps_1), "tzapps_715.b01");
        sprintf((char *)(tzapps_2), "tzapps_715.b02");
        sprintf((char *)(tzapps_3), "tzapps_715.b03");
        sprintf((char *)(tzapps_m), "tzapps_715.mdt");
    }

    pr_info("[tzappss]: %s, %s, %s, %s, %s.\n", tzapps_0, tzapps_1, tzapps_2, tzapps_3, tzapps_m);
    
    keymaster_0 = (char *) kmalloc(32, GFP_KERNEL);
    keymaster_1 = (char *) kmalloc(32, GFP_KERNEL);
    keymaster_2 = (char *) kmalloc(32, GFP_KERNEL);
    keymaster_3 = (char *) kmalloc(32, GFP_KERNEL);
    keymaster_m = (char *) kmalloc(32, GFP_KERNEL);
        if( (keymaster_0 == NULL) || (keymaster_1 == NULL) || (keymaster_2 == NULL) || (keymaster_3 == NULL) || (keymaster_m == NULL) ) {
        pr_info("[keymaster]: malloc(32) fail.\n");
    }
    memset( keymaster_0, 0, 32 );
    memset( keymaster_1, 0, 32 );
    memset( keymaster_2, 0, 32 );
    memset( keymaster_3, 0, 32 );
    memset( keymaster_m, 0, 32 );

    pr_info("[keymaster]: g_A68_cpuID=%d.\n", g_A68_cpuID);

    if( (g_A68_cpuID >= 714) && (g_A68_cpuID <= 719) ) {
        sprintf((char *)(keymaster_0), "keymaster_%d.b00", g_A68_cpuID);
        sprintf((char *)(keymaster_1), "keymaster_%d.b01", g_A68_cpuID);
        sprintf((char *)(keymaster_2), "keymaster_%d.b02", g_A68_cpuID);
        sprintf((char *)(keymaster_3), "keymaster_%d.b03", g_A68_cpuID);
        sprintf((char *)(keymaster_m), "keymaster_%d.mdt", g_A68_cpuID);
    }
    else {
        sprintf((char *)(keymaster_0), "keymaster_715.b00");
        sprintf((char *)(keymaster_1), "keymaster_715.b01");
        sprintf((char *)(keymaster_2), "keymaster_715.b02");
        sprintf((char *)(keymaster_3), "keymaster_715.b03");
        sprintf((char *)(keymaster_m), "keymaster_715.mdt");
    }

    pr_info("[keymasters]: %s, %s, %s, %s, %s.\n", keymaster_0, keymaster_1, keymaster_2, keymaster_3, keymaster_m);
