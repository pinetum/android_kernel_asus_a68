...
#if defined(ASUS_CN_CHARGER_BUILD) && !defined(ASUS_FACTORY_BUILD) //ASUS_BSP Enter_Zhang charging mode porting
...
#endif //ASUS_BSP Enter_Zhang charging mode porting ---
        case CHARGING_RESUME_EVENT: 
        case CHARGING_FULLDROP_EVENT:    
        default : 
            //don't care...
