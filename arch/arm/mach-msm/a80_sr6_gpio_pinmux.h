#ifndef __a80_sr6_GPIO_PINMUX_H
#define __a80_sr6_GPIO_PINMUX_H

#include "a80_gpio_pinmux_setting.h"

static struct msm_gpiomux_config a80_sr6_msm8960_gpio_configs[] = {
        {
                .gpio = 0,
                .settings = {
...
/*		.gpio      = 17,
        ...
        {       //AP_PWR_KEY_N
                ...
                .settings = {
                        ...
                        [GPIOMUX_SUSPENDED] = &gpio_power_keys_cfg,//ASUS BSP HANS
                },
        },
        //ASUS_BSP+++ BennyCheng "config apq-mdm gpio default settings"
        ...
        {       
      		//BUT_VOL_UP
                ...
                .settings = {
                        ...
                        [GPIOMUX_SUSPENDED] = &gpio_volup_keys_cfg,//Austin
                },
        },
        /*
        {
        ...
        */
        {       //BUT_VOL_DOWN
                ...
                .settings = {
                        ...
                        [GPIOMUX_SUSPENDED] = &gpio_voldown_keys_cfg,//Austin
                },
        },
        //ASUS_BSP+++ BennyCheng "config apq-mdm gpio default settings"
        {       //AP2MDM_WAKEUP
...
//ASUS_BSP larry lai : for MHL Reset setting +++        
        {       //MHL RST 
                .gpio = 43,
                .settings = {
                    [GPIOMUX_ACTIVE] = &O_L_cfg,   		//ASUS BSP Wei_Lai +++++
                    [GPIOMUX_SUSPENDED] = &O_L_cfg,
                },
        },
//ASUS_BSP larry lai : for MHL Reset setting ---        
        ...
        //ASUS_BSP+++ larrylai : myDP interrupt 
        {       // myDP INT
                .gpio      = 45,
                .settings = {
                        [GPIOMUX_ACTIVE] = &I_NP_cfg,
...
//ASUS_BSP +++ Stimber "[A68][13M][NA][Others]Full porting for 13M camera with ISP"
		{
				...
				.settings = {
                    [GPIOMUX_ACTIVE]    = &I_NP_cfg,          						//ASUS BSP Wei_Lai +++
                    [GPIOMUX_SUSPENDED] = &I_NP_cfg,							//ASUS BSP Wei_Lai +++
				},
		},
//ASUS_BSP --- Stimber "[A68][13M][NA][Others]Full porting for 13M camera with ISP"
//ASUS_BSP : Louis ++
...
//         },
		...
		//ASUS_BSP+++ LarryLai : for myDP chip, set usb_id to input NO PULL
        {       //USB_HS_ID
                .gpio = 77,
                .settings = {
                        [GPIOMUX_ACTIVE] = &I_NP_cfg,
...
/*                .gpio = 84,
        ...
        {       //1.2M_MCLK_EN_N
                ...
                .settings = {
                    [GPIOMUX_ACTIVE] = &O_L_cfg,
                    [GPIOMUX_SUSPENDED] = &O_L_cfg, //ASUS_BSP LiJen "[A80][Camera][NA][Others]config vga_mclk_en gpio default settings"
                },
        },
        //ASUS_BSP+++ BennyCheng "config hsic gpio default settings"
        {       //HSIC_STROBE
