...
//ASUS_BSP +++ Josh_Liao "only support sdc1 for eMMC"
...
/* SDC1 pad data */
//ASUS_BSP +++ Josh_Liao "tuning sdc1 driving strength for A80"
static struct msm_mmc_pad_drv a80_sdc1_pad_drv_on_cfg[] = {
...
//ASUS_BSP +++ Josh_Liao "tuning sdc1 driving strength for A80"
		apq8064_sdc1_pdata->pin_data->pad_data->drv->on = a80_sdc1_pad_drv_on_cfg;
		apq8064_sdc1_pdata->pin_data->pad_data->drv->size= ARRAY_SIZE(a80_sdc1_pad_drv_on_cfg);
//ASUS_BSP --- Josh_Liao "tuning sdc1 driving strength for A80"
