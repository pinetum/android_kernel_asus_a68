...
static struct clk_lookup msm_clocks_8064[] = {
	...
	CLK_LOOKUP("core_clk",		gsbi2_qup_clk.c,	"qup_i2c.1"),		//ASUS_BSP +++ Maggie_Lee "I2C Porting"
	...
	CLK_LOOKUP("iface_clk",		gsbi2_p_clk.c,		"qup_i2c.1"),		//ASUS_BSP +++ Maggie_Lee "I2C Porting"
