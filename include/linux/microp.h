...
#define ASUS_MICROP_IS_UNDER_APROM	_IOWR(ASUS_MICROP_IOC_TYPE,	7,	int)
#ifdef CONFIG_EEPROM_NUVOTON_A80
#define ASUS_MICROP_POWER_ON_LED_O	_IOWR(ASUS_MICROP_IOC_TYPE,	8,	int)
#define ASUS_MICROP_POWER_OFF_LED_O	_IOWR(ASUS_MICROP_IOC_TYPE,	9,	int)
#define ASUS_MICROP_POWER_ON_LED_G	_IOWR(ASUS_MICROP_IOC_TYPE,	10,	int)
#define ASUS_MICROP_POWER_OFF_LED_G	_IOWR(ASUS_MICROP_IOC_TYPE,	11,	int)
#define ASUS_MICROP_PAD_MODEL_NAME  _IOWR(ASUS_MICROP_IOC_TYPE,	12,	char[24])
#define ASUS_MICROP_MAX_NR  12
#else
#define ASUS_MICROP_MAX_NR  7
#endif
