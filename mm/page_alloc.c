...
static void __setup_per_zone_wmarks(void)
{
	...
	for_each_zone(zone) {
		...
		printk("zone->watermark[WMARK_LOW] = %d\r\n",(unsigned int)zone->watermark[WMARK_LOW]);  //josh++
		printk("zone->watermark[WMARK_HIGH] = %d\r\n",(unsigned int)zone->watermark[WMARK_HIGH]);  //josh++
